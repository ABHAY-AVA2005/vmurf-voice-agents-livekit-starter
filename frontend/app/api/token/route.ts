...
async function createConnectionDetails(req: Request): Promise<ConnectionDetails> {
  ...
  if (body?.room_config) {
    ...
    roomConfig = RoomConfiguration.fromJson(rawRoomConfig, {
...
export async function POST(req: Request) {
  try {
    const data = await createConnectionDetails(req);
